...
class inventory():
    ...
    def open(self):
        ...
        while not self.is_open():
            attempts += 1
            logger.debug(f"trying to open player inventory {attempts} / {source.ASA.config.inventory_open_attempts}")
    ...
    def close(self):
        ...
        while self.is_open():
            attempts += 1
            logger.debug(f"trying to close objects inventory {attempts} / {source.ASA.config.inventory_close_attempts}")
